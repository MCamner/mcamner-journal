# McAmner Journal — Knowledge Base

Vector store index. High-signal files only.
...
| [posts/macos-scripts.md](posts/macos-scripts.md) | Note 007 | Modular automation, CLI design |
| [posts/stalker.md](posts/stalker.md) | Film 006 | Film voice — Tarkovsky |
| [posts/le-samourai.md](posts/le-samourai.md) | Film 008 | Film voice — Melville, economy |
| [posts/back-in-black.md](posts/back-in-black.md) | Music 003 | Music voice — discipline |
| [posts/ways-of-seeing.md](posts/ways-of-seeing.md) | Book 001 | Curatorial voice — Berger |
| [posts/pattern-language.md](posts/pattern-language.md) | Book 002 | Systems/design voice — Alexander |
...
- `assets/` — images, no retrieval value
- `robots.txt` — no retrieval value
- `.DS_Store` — never
- Individual CSS/JS — covered in design-language.md and ui-principles.md
